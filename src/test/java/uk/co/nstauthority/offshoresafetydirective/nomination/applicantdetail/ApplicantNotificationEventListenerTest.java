  ...
  class GivenDecisionOnNomination {
    ...
    class WhenTeamMembersExist {
      ...
      void thenEachTeamMemberReceivesAnEmail() {
        ...
        var firstTeamMember = EnergyPortalUserDtoTestUtil.Builder()
            .withForename("first")
            .withEmailAddress("first@example.com")
            .build();

        var secondTeamMember = EnergyPortalUserDtoTestUtil.Builder()
            .withForename("second")
            .withEmailAddress("second@example.com")
            .build();

        given(nominationRoleService.getUsersInApplicantOrganisationTeamWithAnyRoleOf(
            NOMINATION_DETAIL,
            Set.of(
        ...
        then(emailService)
            ...
            .sendEmail(
                refEq(
                    template
                        .withMailMergeField(EmailService.RECIPIENT_IDENTIFIER_MERGE_FIELD_NAME, firstTeamMember.forename())
