...
@ContextConfiguration(classes = NominationConsultationResponseFileController.class)
@EnableConfigurationProperties(FileUploadConfig.class)
class NominationConsultationResponseFileControllerTest extends AbstractControllerTest {
  ...
  @BeforeEach
  void setUp() {
    when(teamMemberService.getUserAsTeamMembers(NOMINATION_MANAGER))
  ...
  void upload_assertStatusesPermitted() {
    ...
    NominationStatusSecurityTestUtil.smokeTester(mockMvc)
        ...
        .withUser(NOMINATION_MANAGER)
        .withMultipartFilePostEndpoint(
            ReverseRouter.route(on(NominationConsultationResponseFileController.class).upload(NOMINATION_ID, null)),
            mockMultipartFile,
            status().isOk(),
            status().isForbidden()
        )
  ...
  void upload_verifyCalls() throws Exception {
    ...
    mockMvc.perform(multipart(ReverseRouter.route(
            on(NominationConsultationResponseFileController.class).upload(NOMINATION_ID, null)))
            .file(mockMultipartFile)
            .with(user(NOMINATION_MANAGER))
            .with(csrf()))
  ...
  void delete_assertStatusesPermitted() {
    ...
    NominationStatusSecurityTestUtil.smokeTester(mockMvc)
        ...
        .withPostEndpoint(
            ReverseRouter.route(
                on(NominationConsultationResponseFileController.class).delete(NOMINATION_ID,
  ...
  void download_assertStatusesPermitted() {
    ...
    NominationStatusSecurityTestUtil.smokeTester(mockMvc)
        ...
        .withGetEndpoint(
            ReverseRouter.route(
                on(NominationConsultationResponseFileController.class).download(NOMINATION_ID,
                    new UploadedFileId(fileUuid))),
            status().isOk(),
            status().isForbidden()
        )
