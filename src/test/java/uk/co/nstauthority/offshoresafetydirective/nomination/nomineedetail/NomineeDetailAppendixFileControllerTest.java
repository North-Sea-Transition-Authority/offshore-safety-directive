...
@ContextConfiguration(classes = NomineeDetailAppendixFileController.class)
...
class NomineeDetailAppendixFileControllerTest extends AbstractControllerTest {
  ...
  void upload_assertStatusesPermitted() {
    ...
    when(nominationDetailService.getNominationDetail(nominationDetailId)).thenReturn(Optional.of(nominationDetail));
    ...
    NominationStatusSecurityTestUtil.smokeTester(mockMvc)
        ...
        .withMultipartFilePostEndpoint(
            ReverseRouter.route(
                on(NomineeDetailAppendixFileController.class).upload(NOMINATION_ID, nominationDetailId, null)),
            mockMultipartFile,
            status().isOk(),
            status().isForbidden()
        )
  ...
  void delete_assertStatusesPermitted() {
    ...
    NominationStatusSecurityTestUtil.smokeTester(mockMvc)
        ...
        .withPostEndpoint(
            ReverseRouter.route(
                on(NomineeDetailAppendixFileController.class).delete(NOMINATION_ID, nominationDetailId,
  ...
  void download_assertStatusesPermitted() {
    ...
    NominationStatusSecurityTestUtil.smokeTester(mockMvc)
        ...
        .withGetEndpoint(
            ReverseRouter.route(
                on(NomineeDetailAppendixFileController.class).download(NOMINATION_ID, nominationDetailId,
                    new UploadedFileId(fileUuid))),
            status().isOk(),
            status().isForbidden()
        )
