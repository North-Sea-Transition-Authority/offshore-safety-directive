...
@Service
class ConsulteeTeamMemberEditRolesValidator implements SmartValidator {
  ...
  @Autowired
  ConsulteeTeamMemberEditRolesValidator(TeamMemberRemovalService teamMemberRemovalService) {
  ...
  public void validate(@Nullable Object target, @Nullable Errors errors, Object... validationHints) {
    // OSDOP-425 - Merge with RegulatorTeamMemberEditRolesValidator
  ...
  private boolean canUpdateTeamMemberWithNewRoles(Team team, TeamMember teamMember,
                                                  Collection<ConsulteeTeamRole> newRoles) {

    var accessManagerRole = ConsulteeTeamRole.ACCESS_MANAGER;
