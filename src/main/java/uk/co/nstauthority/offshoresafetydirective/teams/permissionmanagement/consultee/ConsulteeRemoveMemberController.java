...
@Controller
@RequestMapping("/permission-management/consultee/{teamId}/remove/{wuaId}")
@HasTeamPermission(
    anyTeamPermissionOf = RolePermission.GRANT_ROLES,
    anyNonTeamPermissionOf = RolePermission.MANAGE_CONSULTEE_TEAMS
)
public class ConsulteeRemoveMemberController extends AbstractTeamController {
  ...
  @Autowired
  public ConsulteeRemoveMemberController(TeamMemberService teamMemberService,
  ...
  public ModelAndView renderRemoveMember(@PathVariable("teamId") TeamId teamId,
    ...
    return new ModelAndView("osd/permissionmanagement/removeTeamMemberPage")
        ...
        .addObject("backLinkUrl", ReverseRouter.route(on(ConsulteeTeamManagementController.class)
            .renderMemberList(teamId)))
        .addObject("removeUrl", ReverseRouter.route(on(ConsulteeRemoveMemberController.class)
  ...
  public ModelAndView removeMember(@PathVariable("teamId") TeamId teamId,
    ...
    if (!teamMemberRemovalService.canRemoveTeamMember(team, wuaId, ConsulteeTeamRole.ACCESS_MANAGER)) {
    ...
    teamMemberRemovalService.removeTeamMember(team, teamMember, ConsulteeTeamRole.ACCESS_MANAGER);
