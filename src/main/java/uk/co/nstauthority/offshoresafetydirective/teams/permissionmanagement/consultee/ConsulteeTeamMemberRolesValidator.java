...
@Service
class ConsulteeTeamMemberRolesValidator implements Validator {
  ...
  public void validate(@NonNull Object target, @NonNull Errors errors) {
    ...
    // TODO OSDOP-425 - Merge with RegulatorTeamMemberRolesValidator
    ...
    if (selectedRolesFromForm != null && !selectedRolesFromForm.isEmpty()) {
      ...
      var validRolesFromForm = selectedRolesFromForm
          .stream()
          .filter(role -> ConsulteeTeamRole.getRoleFromString(role).isPresent())
          .count();
